...
(async () => {
  ...
  await page.goto('https://www.youtube.com/watch?v=rYxt0BeTrT8');
  ...
  // write to file, save to db, etc.
	fs.writeFile('./comments.js', 'var gretaArray = ' + JSON.stringify(comments) + ';' , function(error){
        console.log("bestand is geschreven!");
	});
